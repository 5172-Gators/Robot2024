...
public class StowClimberRoutine extends SequentialCommandGroup {
  /** Creates a new StowClimberRoutine. */
  Turret s_Turret;
  Pitch s_Pitch;
  Climber s_Climber;
  
  public StowClimberRoutine(Pitch pitch, Turret turret, Climber climber) {
