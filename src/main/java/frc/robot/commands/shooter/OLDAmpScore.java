...
public class OLDAmpScore extends SequentialCommandGroup {
  ...
  public OLDAmpScore(double leftRPM, double rightRPM, BooleanSupplier fire, DoubleSupplier yaw_aim, DoubleSupplier pitch_aim, Shooter shooter, Pitch pitch, Turret turret, Climber climber, Kicker kicker, LEDs leds) {
